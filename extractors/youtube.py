...
# - Proxies/VPN: support env YTDLP_HTTP_PROXY / HTTPS_PROXY / ALL_PROXY → yt-dlp & http_probe
...
def _mk_opts(
    *,
    ...
    ydl_opts: Dict[str, Any] = {
        ...
        "retries": 5,
        "fragment_retries": 5,
        # IPv4 souvent plus stable sur Railway (évite des 403 IPv6/DC)
